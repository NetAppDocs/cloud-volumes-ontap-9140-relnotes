...
== 9.14.0 P2 ( 2024)
The 9.14.0 P1 patch is now available for Cloud Volumes ONTAP for all cloud providers. This patch is only available for manual upgrade. See https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-updating-ontap-cloud.html#upgrade-from-bluexp-notifications[Upgrade from an image available at a URL]. 

We recommend that going forward, you upgrade Cloud Volumes ONTAP 9.14.0 to 9.14.1. 
